...
use sp_core::U256;
// Runtime
use aya_runtime::{opaque::Block, Hash, TransactionConverter};
    ...
    Executor: NativeExecutionDispatch + 'static,
{
    ...
    impl sp_inherents::InherentDataProvider for MockTimestampInherentDataProvider {
        async fn provide_inherent_data(
            ...
            TIMESTAMP.with(|x| {
                *x.borrow_mut() += aya_runtime::SLOT_DURATION;
...
pub async fn build_full(
    ...
    new_full::<aya_runtime::RuntimeApi, TemplateRuntimeExecutor>(config, eth_config, sealing).await
}
...
> {
    ...
    let PartialComponents {
        ...
        other,
        ..
    } = new_partial::<aya_runtime::RuntimeApi, TemplateRuntimeExecutor, _>(
        config,
        eth_config,
