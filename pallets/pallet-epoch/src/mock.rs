...
use sp_core::H256;
use sp_runtime::{
    impl_opaque_keys, testing::UintAuthorityId, traits::OpaqueKeys, KeyTypeId,
	RuntimeAppPublic,
...
impl<BlockNumber: PartialEq + From<u32>> pallet_session::ShouldEndSession<BlockNumber> for DummyShouldEndSession {
